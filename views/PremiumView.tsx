    ...
    <div className="min-h-screen bg-black relative p-6 overflow-y-auto pb-24">
      ...
      <div className="space-y-4 mb-10">
        <div className="relative transform active:scale-95 transition-transform">
          ...
          <a 
            href={PAYMENT_LINKS.MONTHLY}
            className="w-full bg-white/5 backdrop-blur-md border-2 border-neon/50 rounded-2xl p-6 flex justify-between items-center relative overflow-hidden group block no-underline"
          >
        ...
        <a 
          ...
          className="w-full bg-dark-gray/40 border border-white/5 rounded-2xl p-6 flex justify-between items-center hover:bg-white/5 transition-all block no-underline"
        >
           <div className="text-left">
              <div className="text-white font-bold">ANUAL</div>
              <div className="text-[10px] text-gray-500">MELHOR CUSTO-BENEFÍCIO</div>
          </div>
