...
import { Crown, Edit, LogOut, Shield } from 'lucide-react';
    ...
    <div className="min-h-screen bg-black p-6 pb-32 animate-fade-in">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
            ...
            <p className="text-gray-400 text-sm">{userProfile.goal} • {userProfile.level}</p>
        </div>
      </div>
        ...
        <div className="bg-gradient-to-r from-purple-900/40 to-blue-900/40 p-4 rounded-2xl border border-purple-500/30 mb-8">
            <div className="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p className="text-xs text-gray-400">Acesso ilimitado ativo</p>
                </div>
            </div>
        </div>
      )}
      ...
      <div className="space-y-4">
        <button onClick={onEditProfile} className="w-full bg-dark-gray p-4 rounded-xl flex items-center justify-between text-white hover:bg-gray-800 transition-colors border border-white/5">
            <div className="flex items-center gap-3">
                <Edit className="w-5 h-5 text-gray-400" />
                <span>Editar Dados Corporais</span>
            </div>
        </button>
        
        <div className="p-4 bg-dark-gray rounded-xl space-y-4 border border-white/5">
      ...
      <div className="mt-12 pt-8 border-t border-white/10 text-center">
        <p className="text-gray-600 text-xs">FitScan Brasil v1.2.0</p>
        <p className="text-gray-700 text-[10px] mt-1">Feito com Inteligência Artificial</p>
      </div>
    </div>
  );
};